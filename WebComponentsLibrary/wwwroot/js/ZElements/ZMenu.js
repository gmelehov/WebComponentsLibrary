...
let ZMenu = ZMenu_1 = class ZMenu extends PolymerElement {
    ...
    static get template() {
        return html `
		<style>
			:host { box-sizing: border-box; display: block; opacity: 1; position: fixed; text-align: left; z-index: 10001; padding: 8px 0; background-color: hsl(0, 0%, 100%); width: max-content; transition: var(--z-medium-transition); border-radius: 2px; }
