...
import { ZExpandable } from '../ZExpandable/ZExpandable.js';
import { ZCollapser } from '../ZCollapser/ZCollapser.js';
...
import { ZExpanders } from '../ZExpanders/ZExpanders.js';
...
export class ZExpander extends PolymerElement
{
  static get template()
  {
    ...
    <z-paper z="{{z}}" b-color="white">
      <z-collapser name="{{name}}" icon="{{icon}}" color="{{color}}" on-click="toggleOpened"></z-collapser>
