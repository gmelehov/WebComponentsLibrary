 ...
 * @returns {HTMLElement}
 */
export function alignElement(element: HTMLElement, target?: HTMLElement, position?: OverlayPosition, autoCenter?: boolean, xBias?: number, yBias?: number): HTMLElement
{
	...
	let domHeight = getHeight(),
		...
		targetBoundings = getBoundings(target || document.documentElement),
		newBoundings = null,
		xbias = xBias || 0,
		ybias = yBias || 0;
