import { IPolymerDomRepeatModel } from '../Interfaces/interfaces.js';
 ...
 */
export function composePolymerDomRepeatTemplate(model: IPolymerDomRepeatModel, templateContent?: string): HTMLTemplateElement
{
