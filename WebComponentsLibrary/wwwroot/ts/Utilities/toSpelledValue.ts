 ...
 */
export function toSpelledValue(numb: number, units?: string): string
{
	let ret = '';
...
function getProperMeasureForm(numb: number)
{
...
function toSpelled(numb: number, _isFemaleGender?: boolean, _spellZeroValue?: boolean): string
{
	let ret = '';
