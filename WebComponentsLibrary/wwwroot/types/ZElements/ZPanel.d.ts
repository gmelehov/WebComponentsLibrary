...
declare const ZPanel_base: {
    new (...input: any[]): {
        connectedCallback(): void;
        disconnectedCallback(): void;
        resizers: string;
        toggleEventListeners(): void;
        handleResize(e: CustomEvent<any>): void;
        _doHandleResizeStart(elem: any): void;
        _doHandleResizeTrack(e: CustomEvent<any>, elem: any): void;
...
export declare class ZPanel extends ZPanel_base {
}
export {};
