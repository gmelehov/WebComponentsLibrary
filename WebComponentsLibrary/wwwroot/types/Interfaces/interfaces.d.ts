...
export declare type FuncPredicate = (a: Primitive, b: Primitive) => boolean;
...
export declare type GridTileMetrics = IScreenPositions & IScreenSizes;
...
export declare type InputType = 'date' | 'text' | 'number' | 'month' | 'week' | 'password';
...
export declare type HTTPMethodType = 'GET' | 'POST' | 'PUT' | 'DELETE';
export declare type XHRResponseType = 'text' | 'xml' | 'json' | 'arraybuffer' | 'blob' | 'document';
