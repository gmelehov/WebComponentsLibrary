...
export declare const ResizableMixin: <U extends AnyConstructor<PolymerElement>>(base: U) => {
    new (...input: any[]): {
        ...
        wmax: number;
        toggleEventListeners(): void;
        handleResize(e: Event): void;
        _doHandleResizeStart(elem: any): void;
        _doHandleResizeTrack(e: Event, elem: any): void;
        _doHandleResizeEnd(elem: any): void;
        safePreventDefault(event: Event): void;
        _createResizersSlot(): void;
        _createResizersStyles(): void;
        resizersChanged(newval: string, oldval: string): void;
        getClosestPosition(x: number, y: number, rows?: number, cols?: number, floorHalf?: boolean): IScreenPositions;
        getClosestSize(width: number, height: number, maxWidth?: number, maxHeight?: number): IScreenSizes;
        accessKey: string;
